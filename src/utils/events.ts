export enum Events {
    ...
    // Game events
    GAME_SCORE_REQUEST = "GAME_SCORE_REQUEST",
    GAME_SCORE_RESPONSE_SUCCESS = "GAME_SCORE_RESPONSE_SUCCESS",
    GAME_SCORE_RESPONSE_FAIL = "GAME_SCORE_RESPONSE_FAIL",
    GAME_WIN_REQUEST = "GAME_WIN_REQUEST",
    GAME_WIN_RESPONSE_SUCCESS = "GAME_WIN_RESPONSE_SUCCESS",
    GAME_WIN_RESPONSE_FAIL = "GAME_WIN_RESPONSE_FAIL",
